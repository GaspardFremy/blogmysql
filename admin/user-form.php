				...
				<section class="col-9">
					...
					<form action="user-form.php" method="post">
						<div class="form-group">
							...
							<input class="form-control" <?php if(isset($user)): ?>value="<?php echo $user['first_name']?>"<?php endif; ?> type="text" placeholder="Prénom" name="firstname" id="firstname" />
						</div>
						<div class="form-group">
							<label for="lastname">Nom de famille : </label>
							<input class="form-control" <?php if(isset($user)): ?>value="<?php echo $user['last_name']?>"<?php endif; ?> type="text" placeholder="Nom de famille" name="lastname" id="lastname" />
						</div>
						<div class="form-group">
